<x-app-layout>
        ...
        <div class="flex justify-between items-center">
            <div>
                <h2 class="font-bold text-2xl text-gray-900 leading-tight">
                    <i class="fas fa-plus mr-3 text-indigo-600"></i>Add Service
                </h2>
                <p class="text-sm text-gray-600 mt-1">Create a new service offering for your portfolio</p>
            </div>
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="description" 
                                  ...
                                  required
                                  class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition duration-200"
                                  placeholder="Describe your service in detail. What do you offer? What problems do you solve? What makes your service unique?">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select name="price_type" 
                                ...
                                <option value="hourly" {{ old('price_type') == 'hourly' ? 'selected' : '' }}>Per Hour</option>
                                ...
                                <option value="project" {{ old('price_type') == 'project' ? 'selected' : '' }}>Per Project</option>
                            </select>
                            @error('price_type')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
            ...
            <div class="bg-white overflow-hidden shadow-xl rounded-2xl border border-gray-200">
                ...
                <div class="p-6">
                    <div id="features-container">
                        <div class="feature-input flex items-center space-x-2 mb-3">
                            <input type="text" 
                                   name="features[]" 
    ...
    <script>
        ...
        // Add old features if validation fails
        @if(old('features'))
            document.addEventListener('DOMContentLoaded', function() {
                const features = @json(old('features'));
                const container = document.getElementById('features-container');
