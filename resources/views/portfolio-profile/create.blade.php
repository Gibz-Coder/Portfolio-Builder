<x-app-layout>
        ...
        <div class="flex justify-between items-center">
            <div>
                <h2 class="font-bold text-2xl text-gray-900 leading-tight">
                    <i class="fas fa-plus mr-3 text-blue-600"></i>Create Portfolio Profile
                </h2>
                <p class="text-sm text-gray-600 mt-1">Set up your professional profile information</p>
            </div>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <form action="{{ route('portfolio-profile.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
            @csrf
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="bio" 
                                  ...
                                  rows="4"
                                  class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200"
                                  placeholder="Write a brief professional bio that highlights your expertise and experience...">{{ old('bio') }}</textarea>
                        @error('bio')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="about_me" 
                                  ...
                                  rows="6"
                                  class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200"
                                  placeholder="Tell visitors more about yourself, your passions, and what drives you professionally...">{{ old('about_me') }}</textarea>
                        @error('about_me')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
