        ...
        <div class="flex justify-between items-center">
            <div>
                <h2 class="font-bold text-2xl text-gray-900 leading-tight">
                    <i class="fas fa-plus mr-3 text-purple-600"></i>Add New Skill
                </h2>
                <p class="text-sm text-gray-600 mt-1">Add a new skill to your portfolio</p>
            </div>
        ...
        <form action="{{ route('skills.store') }}" method="POST" class="space-y-8">
            ...
            <div class="bg-white overflow-hidden shadow-xl rounded-2xl border border-gray-200">
                <div class="px-6 py-4 border-b border-gray-100 bg-gradient-to-r from-purple-50 to-blue-50">
                    ...
                    <p class="text-sm text-gray-600">Enter your skill information</p>
                </div>
                <div class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <select name="category" 
                            ...
                            <option value="Frameworks" {{ old('category') == 'Frameworks' ? 'selected' : '' }}>Frameworks</option>
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="text-center">
                                <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-purple-100 text-purple-800">
                                    <span id="proficiency-value">{{ old('proficiency', 50) }}</span>% Proficiency
                                </span>
                            </div>
                        </div>
                        @error('proficiency')
                    ...
                    <div>
                        ...
                        <textarea name="description" 
                                  ...
                                  rows="4"
                                  class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition duration-200"
                                  placeholder="Describe your experience with this skill, projects you've used it in, or any certifications...">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
