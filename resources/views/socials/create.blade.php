<x-app-layout>
        ...
        <div class="flex justify-between items-center">
            <div>
                <h2 class="font-bold text-2xl text-gray-900 leading-tight">
                    <i class="fas fa-plus mr-3 text-pink-600"></i>Add Social Link
                </h2>
                <p class="text-sm text-gray-600 mt-1">Add a social media profile or link to your portfolio</p>
            </div>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <form action="{{ route('socials.store') }}" method="POST" class="space-y-8">
            @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select name="platform" 
                                ...
                                <option value="dev" {{ old('platform') == 'dev' ? 'selected' : '' }}>Dev.to</option>
            ...
            <div class="flex justify-end space-x-4">
                ...
                <button type="submit" 
                    ...
                    <i class="fas fa-save mr-2"></i>Add Social Link
                </button>
            </div>
        </form>
    </div>
